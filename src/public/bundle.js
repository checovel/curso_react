...
var AddForm = function (_React$Component) {
  ...
  _createClass(AddForm, [{
    ...
    value: function onSubmitHandler(evt) {
      ...
      this.props.dispatch(this.props.listId ? (0, _actions.AddItem)(this.props.listId, this.state.value) : (0, _actions.AddNewTodoList)(this.state.value));
      this.setState({ value: '' });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'form',
        { style: { marginTop: '5px' }, action: '#', method: 'post', onSubmit: this.onSubmitHandler },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { type: 'submit', className: 'btn btn-info btn-flat', value: title })
          )
        )
      );
    }
...
//window.getNextId =((n = 0)=> () => n =+ 1)();
window.ids = { get: function get() {
    return this.n++;
  }, n: 0 };
window.store = store;
window.ToggleTodoList = _actions.ToggleTodoList;
var Title = function Title(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'button',
        { type: 'button', className: 'btn btn-box-tool', 'data-widget': 'remove' },
...
var App = function App(_ref2) {
  ...
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(Title, { text: 'Todo list with React' }),
    _react2.default.createElement(
      'div',
      { className: 'box-body' },
      _react2.default.createElement(
        ...
        todoslist.map(function (tl) {
          return _react2.default.createElement(_index2.default, _extends({}, tl, { key: 'key-' + ids.get(), dispatch: dispatch }));
        })
      )
    ),
    _react2.default.createElement(
...
var appRender = function appRender(state) {
  return (0, _reactDom.render)(_react2.default.createElement(App, { todoslist: state, dispatch: store.dispatch }), //list={multipleTodos.getState()}
...
store.subscribe(function () {
  return appRender(store.getState());
});

store.dispatch((0, _actions.AddNewTodoList)('supermarket'));
store.dispatch((0, _actions.AddNewTodoList)('React Lesson'));
store.dispatch((0, _actions.AddNewTodoList)('Guitar Hero'));
store.dispatch((0, _actions.ToggleTodoList)(store.getState()[0].listId));
store.dispatch((0, _actions.EditTodoList)(store.getState()[0].listId, 'coto'));
store.dispatch((0, _actions.AddItem)(store.getState()[0].listId, 'Comprar red bull'));
store.dispatch((0, _actions.AddItem)(store.getState()[0].listId, 'eliminar item, eliminar lista, toggle item'));
//console.info(store.getState()[0].listId, store.getState()[0].todos[0].itemId);
store.dispatch((0, _actions.ToggelItem)(store.getState()[0].listId, store.getState()[0].todos[0].itemId));
store.dispatch((0, _actions.EditItemName)(store.getState()[0].listId, store.getState()[0].todos[0].itemId, 'Comprar Leche'));
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'checkbox',
            ...
            onChange: function onChange() {
                return dispatch((0, _actions.ToggleTodoList)(listId));
            }
        }),
        _react2.default.createElement(
            'span',
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement('i', { className: 'fa fa-trash-o', onClick: function onClick() {
                    return dispatch((0, _actions.RemoveTodoList)(listId));
                } })
        ),
        _react2.default.createElement(
            'ul',
        ...
        _react2.default.createElement(_index4.default, { title: 'New Item', listId: listId, dispatch: dispatch })
    );
};
...
var TodoItem = function TodoItem(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement('input', {
      ...
      checked: '' + (completed ? 'checked' : ''),
      onChange: function onChange() {
        return dispatch((0, _actions.ToggelItem)(listId, itemId));
      }
    }),
    _react2.default.createElement(
      'span',
      { className: completed ? 'text-green' : 'text-yellow' },
      name
    ),
    _react2.default.createElement(
      'div',
      ...
      _react2.default.createElement('i', { className: 'fa fa-edit' }),
      _react2.default.createElement('i', { className: 'fa fa-trash-o', onClick: function onClick() {
          return dispatch((0, _actions.RemoveItem)(listId, itemId));
        } })
    )
  );
};
...
var _todoslist = __webpack_require__(54);
...
var _todositems = __webpack_require__(55);

var _todositems2 = _interopRequireDefault(_todositems);
...
var todosList = function todosList() {
  ...
  switch (action.type) {
    case 'ADD_NEW_TODOS_LIST':
      return { name: action.name, todos: [], completed: false, listId: (0, _utils.getId)() };
    case 'REMOVE_TODOS_LIST':
      return state.listId === action.listId;
    case 'TOGGLE_TODOS_LIST':
      return state.listId === action.listId ? Object.assign({}, state, { completed: !state.completed }) : state;
    case 'EDIT_TODOS_LIST':
      return state.listId === action.listId ? Object.assign({}, state, { name: action.name }) : state;
    case 'ADD_ITEM':
      return state.listId === action.listId ? Object.assign({}, state, { todos: [].concat(_toConsumableArray(state.todos), [(0, _todositems2.default)(undefined, action)]) }) : state;
    case 'TOGGLE_ITEM':
      return state.listId === action.listId ? Object.assign({}, state, { todos: state.todos.map(function (itl) {
          return (0, _todositems2.default)(itl, action);
        }) }) : state;
    case 'REMOVE_ITEM':
      return state.listId === action.listId ? Object.assign({}, state, { todos: state.todos.filter(function (itl) {
          return !(0, _todositems2.default)(itl, action);
        }) }) : state;
    case 'EDIT_ITEM_NAME':
      return state.listId === action.listId ? Object.assign({}, state, { todos: state.todos.map(function (itl) {
...
var todosItems = function todosItems() {
  ...
  switch (action.type) {
    case 'ADD_ITEM':
      return { name: action.name, listId: action.listId, completed: false, itemId: (0, _utils.getId)() };
    case 'TOGGLE_ITEM':
      return state.itemId === action.itemId ? Object.assign({}, state, { completed: !state.completed }) : state;
    case 'REMOVE_ITEM':
      return state.itemId === action.itemId;
    case 'EDIT_ITEM_NAME':
      return state.itemId === action.itemId ? Object.assign({}, state, { name: action.name }) : state;
    default:
      return state;
  }
};
...
var AddNewTodoList = exports.AddNewTodoList = function AddNewTodoList(name) {
  return {
...
var RemoveTodoList = exports.RemoveTodoList = function RemoveTodoList(listId) {
  return {
...
var ToggleTodoList = exports.ToggleTodoList = function ToggleTodoList(listId) {
  return {
...
var EditTodoList = exports.EditTodoList = function EditTodoList(listId, name) {
  return {
...
var ToggelItem = exports.ToggelItem = function ToggelItem(listId, itemId) {
  return {
    type: 'TOGGLE_ITEM',
    listId: listId,
    itemId: itemId
